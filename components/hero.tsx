    ...
    <div className="relative h-screen w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
        ...
        <h1 className="mb-4 max-w-3xl text-4xl font-bold tracking-tight text-white md:text-5xl lg:text-6xl">
          ...
          <span className="text-purple-400">AIODEV</span>
        </h1>

        <p className="mb-8 max-w-2xl text-lg text-gray-300 md:text-xl">
          A comprehensive problem-solving platform for frontend and backend
          challenges with an integrated IDE, automated testing, and AI
          assistance.
        </p>
